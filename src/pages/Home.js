...
const Home = () => {
  ...
  const logout = () => {
    window.location.href = 'https://crmxeno.up.railway.app/logout';
  };
        ...
        <div style={styles.cardsContainer}>
          <div style={styles.card} onClick={() => navigate('/campaigns/new')}>
            ...
            <p style={styles.cardText}>
              Build targeted campaigns with custom audience rules
            </p>
          </div>
          ...
          <div style={styles.card} onClick={() => navigate('/campaigns/history')}>
            <div style={styles.cardIcon} className="history-icon">
              ...
              >
                <path
                  d="M11.99 2C6.47 2 2 6.48 2 12C2 17.52 6.47 22 11.99 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 11.99 2ZM12 20C7.58 20 4 16.42 4 12C4 7.58 7.58 4 12 4C16.42 4 20 7.58 20 12C20 16.42 16.42 20 12 20ZM12.5 7H11V13L16.25 16.15L17 15.08L12.5 12.25V7Z"
                  fill="#34D399"
                />
              </svg>
            </div>
            ...
            <p style={styles.cardText}>
              View past campaign performance and analytics
            </p>
          </div>
          ...
          <div style={styles.card} onClick={() => navigate('/ai/messages')}>
            <div style={styles.cardIcon} className="ai-icon">
              ...
              >
                <path
                  d="M21 11.5C21 12.29 20.92 13.05 20.77 13.8C19.82 13.27 18.73 13 17.5 13C14.52 13 12 15.02 12 17.5C12 18.73 12.27 19.82 12.8 20.77C12.2 20.92 11.4 21 10.5 21C5.5 21 1.5 17 1.5 12C1.5 7 5.5 3 10.5 3C15.5 3 19.5 7 19.5 12V12.5C20.17 12.5 20.83 12.5 21 12.5V11.5Z"
                  fill="#A78BFA"
                />
              </svg>
            </div>
